...
def train_validate_model2(task, train_dataloader, validation_dataloader, test_dataloader, device, optimizer, loss_function, epochs, input_size, train_gearnet_weights=None, batch_size=None, dataframe=None, dataframe_test=None):
    best_model = {
        "model": None,
        "lowest_loss": 10000,
        "epoch": None,
...
def main():
    ...
    neural_network = MLP_1_hidden_layer(input_shape=input_size, hidden1=param.hidden1, hidden2=param.hidden2, hidden3=param.hidden3, dropout_rate=param.dropout)
    ...
    final_model, best_model = train_validate_model2(task, train_dataloader, validation_dataloader, test_dataloader, device, optimizer, loss_function, param.epochs, input_size=input_size, train_gearnet_weights=param.with_gearnet_weights, batch_size=param.batch_size, dataframe=df, dataframe_test=df_test)
